        ...
        <div className="card border-0 shadow-sm p-4" style={{ borderRadius: 16 }}>
          ...
          <div className="row g-2 mb-3">
            <div className="col-4">
              ...
              <input type="text" className="form-control" value={gate.name} onChange={e => gate.setName(e.target.value)} required />
            </div>
            <div className="col-4">
              ...
              {gate.mode === 'anonymous' ? (
                ...
                <input type="email" className="form-control" value={gate.email} readOnly
